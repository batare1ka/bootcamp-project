...
<section class="container-lg mt-5 pt-5 text-center blog__item">
        ...
        <p class="fs-6">on Mar 10, 2021 0 Comments</p>
        <img class="img-fluid mt-5 mx-auto d-block" src="{{ \Illuminate\Support\Facades\Storage::url($article->image) }}" alt="">
        <div class="fs-6 mt-4">
            <p class="fw-bold">{{ $article->description }}</p>


            <div class="row mx-auto pt-4 my-5 g-5 justify-content-start">
