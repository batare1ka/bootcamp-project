...
<div id="brand" class="container border-bottom">
  <div class="row m-0 py-3">
    <img class="img-fluid col-lg-2 col-md-4 col-6" src="{{ URL('assets/images/brands/1.png') }}" alt="thereisnoimage" />
    <img class="img-fluid col-lg-2 col-md-4 col-6" src="{{ URL('assets/images/brands/2.png') }}" alt="thereisnoimage" />
    <img class="img-fluid col-lg-2 col-md-4 col-6" src="{{ URL('assets/images/brands/3.png') }}" alt="thereisnoimage" />
    <img class="img-fluid col-lg-2 col-md-4 col-6" src="{{ URL('assets/images/brands/4.png') }}" alt="thereisnoimage" />
    <img class="img-fluid col-lg-2 col-md-4 col-6" src="{{ URL('assets/images/brands/5.png') }}" alt="thereisnoimage" />
    <img class="img-fluid col-lg-2 col-md-4 col-6" src="{{ URL('assets/images/brands/6.png') }}" alt="thereisnoimage" />
  </div>
</div>
...
<script>
 ...
 ( function type(){
  ...
  let letter = word.slice(0, count);
    ...
    letter = "\xa0" + letter;
  console.log(letter == ' ' ? "shit" : letter)
