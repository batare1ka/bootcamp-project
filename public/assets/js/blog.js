...
/***/ "./resources/js/blog/create-article.js":
/*!*********************************************!*\
  !*** ./resources/js/blog/create-article.js ***!
  \*********************************************/
...
var Article = /*#__PURE__*/function () {
  function Article(title, description, category, author, image) {
...
var createArticleForm = document.querySelector("#createArticleForm");

if (createArticleForm) {
  var cleanUpForm = function cleanUpForm() {
    titleInput.value = "";
  ...
  var showErrosOnPage = function showErrosOnPage() {
    ...
    Object.keys(errors[0]).forEach(function (key) {
      var errorTag = document.querySelector(".".concat(key, "Error"));
  ...
  var removeErrosFromPage = function removeErrosFromPage() {
    var formElements = [].concat(_toConsumableArray(createArticleForm.querySelectorAll(".article__error")), _toConsumableArray(createArticleForm.elements));
  ...
  var authorInput = createArticleForm.querySelector("#authorInput");
  ...
  createArticleForm.onsubmit = function (event) {
    ...
    var article = new Article(titleInput.value, descriptionInput.value, categoryInput.value, authorInput.value, imageInput.files[0]);
    article.setFormData();
    axios.post("/api/articles", article.getFormData()).then(function () {
      cleanUpForm();
      removeErrosFromPage();
