...
(() => {
/*!*********************************************!*\
  !*** ./resources/js/products/search-bar.js ***!
  \*********************************************/
var _require = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"),
    axios = _require["default"];

function searchBar() {
  var searchBarForm = document.getElementById("myform");
  var submitButton = searchBarForm.querySelector(".submit__button");
  var inputFrom = searchBarForm.querySelector("input");
  var searchHeader = document.getElementById('header-search');
  var suggestItem = document.querySelector("[suggest-item]");
  var blockWithSuggestions = document.querySelector(".search__sugestion");
  ...
  inputFrom.oninput = function (e) {
    if (e.target.value == "") {
      blockWithSuggestions.style.display = "none";
      searchBody[0].classList.remove("bottom__radius-off");
    }

    var removePreviousSuggestions = document.querySelectorAll(".suggest__item");
    ...
    axios.get("/api/search-suggestions/", {
      ...
      data.forEach(function (suggestion, index) {
        var suggestItemOnPage = suggestItem.content.cloneNode(true).children[0];
        suggestItemOnPage.textContent = suggestion.name;
        suggestItemOnPage.addEventListener("click", function () {
        ...
        if (index == data.length - 1) {
          ...
          document.onmousemove = function (e) {
            var moveClassList = e.target.classList;
